...
public abstract class Menu {
    ...
    protected double Hamburg;
    protected double Papa;
    protected double Refresc;
    protected double Pizzas;
    protected double Nughuets;
    protected double Enesalada;
    protected double Yogurth;
